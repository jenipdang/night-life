...
e7 = Event.create!(name: "Grown-up Rolling", image_url: "https://cdn2.orangecoast.com/wp-content/uploads/sites/7/2019/05/CIZ4399-cmyk-600x401.jpg", date: "Thursday, June 2, 2022", start_time: "20:30", venue_id: v3.id, user_id: jeni.id)
e8 = Event.create!(name: "You're It", image_url: "https://cdn2.orangecoast.com/wp-content/uploads/sites/7/2019/05/DSC_0086-cmyk-600x403.jpg", date: "Wednesday, June 15, 2022", start_time: "19:00", venue_id: v4.id, user_id: jeni.id)
...
Comment.create!(event_id: e1.id, user_id: racheal.id, content: "Oh my gooshhh!! Can't she will be playing in OC. Can't wait!")
Comment.create!(event_id: e1.id, user_id: francis.id, content: "So egggcited for this event!")
Comment.create!(event_id: e9.id, user_id: racheal.id, content: "I want to try silent yoga. It looks so fun.")
Comment.create!(event_id: e2.id, user_id: racheal.id, content: "Can't wait to see him.")
Comment.create!(event_id: e3.id, user_id: racheal.id, content: "Wish there's a guestlist for this event.")
Comment.create!(event_id: e7.id, user_id: matteo.id, content: "This bring back so much memory.")
